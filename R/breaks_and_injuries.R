...
breaks <- tibble(
  start = as.Date(c("2022-11-07", "2023-06-26", "2023-11-19", "2024-02-20", "2024-06-16", "2024-10-05", "2024-12-16", "2025-04-27", "2025-12-15", "2026-05-04")),
  end = as.Date(c("2022-11-20", "2023-07-11", "2023-12-01", "2024-03-07", "2024-06-29", "2024-10-12", "2024-12-30", "2025-05-09", "2026-01-02", "2026-05-17"))
)

injuries <- tibble(
  start = as.Date(c("2021-05-20", "2022-08-22", "2023-04-15", "2024-08-31", "2025-03-15", "2025-08-23", "2026-03-14", "2026-08-01")),
  end = as.Date(c("2021-06-15", "2022-09-13", "2024-04-16", "2024-10-03", "2025-07-11", "2025-09-10", "2026-04-28", as.character(Sys.Date()))),
)
